...
def game():
    ...
    #bg
    debg = pygame.image.load('assets/flappy_assets/bg.jpg')
    debg = pygame.transform.scale(debg, (900,600))

    #bird
    bird = pygame.image.load('assets/flappy_assets/bird.png')
    ...
    class Pipe:
        ...
        def __init__(self):
            ...
            self.hitbox = pygame.image.load('assets/flappy_assets/powtf.jpg')
    ...
    filepoints = open('assets/flappy_assets/points.txt', 'r')
    points = 0
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_SPACE:
                        ...
                        if highpoints<points:
                            filepoints = open('assets/flappy_assets/points.txt','w')
                            highpoints = points
