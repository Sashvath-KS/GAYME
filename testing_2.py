...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        #p1 = pygame.transform.scale(pygame.image.load('player_images\character1.png'),(40,129))
        self.image = pygame.transform.scale_by(pygame.image.load('player_images\character1.png').convert_alpha(),3)
        self.rect = self.image.get_rect(midleft = (0,400))
        p2 = pygame.transform.scale_by(pygame.image.load('player_images\character2.png').convert_alpha(),3)
        p3 = pygame.transform.scale_by(pygame.image.load('player_images\character3.png').convert_alpha(),3)
